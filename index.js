...
const greaterTemp = temperatures.filter ( (temperature) => {return temperature >= 25})
console.log (greaterTemp)

const lessTemp = temperatures.filter ( (temperature) => {return temperature < 20})
...
const convert = temperatures.map ( (temperature) => { return (temperature * 9/5) + 32;})
console.log (convert)
...
const lables = temperatures.map ( (temperature) => {
